...
public class JwtTokenUtil {
         ...
         * @return token令牌
         */
        public String generateToken(String username, PrivateKey privateKey) {
         ...
         * @return 是否有效
         */
        public Boolean validateToken(String token, String userDetails, PublicKey publicKey) {
            String username = getUsernameFromToken(token, publicKey);
            System.out.println(publicKey);
            System.out.println("---------------------------------------------");
            return (username.equals(userDetails) && !isTokenExpired(token, publicKey));
        }
